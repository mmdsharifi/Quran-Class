...
export const SettingsSheet = ({ settings, students, onSave, onImport, onReset, onClose, showToast, confirm }: { 
    ...
    return (
        <div 
            onClick={onClose}
            className="fixed inset-0 z-[60] flex items-end lg:items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200 lg:p-4"
        >
            <div 
                onClick={(e) => e.stopPropagation()}
                className="bg-slate-50 dark:bg-slate-900 w-full lg:max-w-md rounded-t-3xl lg:rounded-3xl shadow-2xl p-6 relative animate-in slide-in-from-bottom lg:zoom-in-95 duration-300 max-h-[90vh] lg:max-h-[85vh] overflow-y-auto"
            >
