...
export const ConfirmationModal = ({ isOpen, title, message, onConfirm, onCancel, confirmText = 'بله', cancelText = 'خیر', isDangerous = false }: any) => {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in duration-200 px-0 lg:p-4">
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl dark:shadow-none w-full lg:max-w-sm p-6 animate-in zoom-in-95 duration-200 border border-transparent dark:border-slate-800">
