  ...
  return (
    ...
    >
      <div 
        ...
        className="bg-slate-50 dark:bg-slate-900 w-full lg:max-w-md rounded-t-3xl lg:rounded-3xl shadow-2xl p-6 relative animate-in slide-in-from-bottom lg:zoom-in-95 duration-300 max-h-[92vh] lg:max-h-[85vh] overflow-y-auto"
      >
